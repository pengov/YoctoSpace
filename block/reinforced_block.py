...
#   ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~   CLASS
class ReinforcedBlock(ModelBlock):
    def __init__(self, pos_ship, space_ship, nothing=False):
        super(ReinforcedBlock, self).__init__(
                life=3000,
                weight=3000,
        ...
        if not nothing:
            ...
            img = self.space_ship.Var.image["reinforced block"].get_transform(flip_x=temp.flip_x, flip_y=temp.flip_y)
